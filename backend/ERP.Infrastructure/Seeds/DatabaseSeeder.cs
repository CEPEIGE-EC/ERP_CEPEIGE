    ...
    public static async Task SeedAsync(ApplicationDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
    {
        ...
        if (!await context.PeriodosAcademicos.AnyAsync())
        {
            context.PeriodosAcademicos.AddRange(
                new PeriodoAcademico { Nombre = "2024 - I Semestre",  Codigo = "2024-I",  AnioAcademico = 2024, FechaInicio = Utc(2024, 3, 1),  FechaFin = Utc(2024, 7, 31),  EsActual = false },
                new PeriodoAcademico { Nombre = "2024 - II Semestre", Codigo = "2024-II", AnioAcademico = 2024, FechaInicio = Utc(2024, 8, 1),  FechaFin = Utc(2024, 12, 20), EsActual = false },
                new PeriodoAcademico { Nombre = "2025 - I Semestre",  Codigo = "2025-I",  AnioAcademico = 2025, FechaInicio = Utc(2025, 3, 1),  FechaFin = Utc(2025, 7, 31),  EsActual = true  }
            );
            await context.SaveChangesAsync();
        }
        ...
        if (!await context.Docentes.AnyAsync())
        {
            context.Docentes.AddRange(
                new Docente { Codigo = "DOC001", Nombres = "Carlos",  ApellidoPaterno = "Quispe",   ApellidoMaterno = "Huanca", DNI = "40123456", FechaNacimiento = Utc(1975, 5, 10),  Sexo = TipoSexo.Masculino, Email = "cquispe@isterp.edu.pe",   GradoAcademico = "Magíster",  Especialidad = "Ingeniería de Software", TipoContrato = TipoContrato.TiempoCompleto, FechaIngreso = Utc(2018, 3, 1),  Sueldo = 3500 },
                new Docente { Codigo = "DOC002", Nombres = "María",   ApellidoPaterno = "Flores",   ApellidoMaterno = "Salas",  DNI = "41234567", FechaNacimiento = Utc(1980, 8, 20),  Sexo = TipoSexo.Femenino,  Email = "mflores@isterp.edu.pe",   GradoAcademico = "Doctora",   Especialidad = "Matemáticas",            TipoContrato = TipoContrato.TiempoCompleto, FechaIngreso = Utc(2015, 1, 15), Sueldo = 4200 },
                new Docente { Codigo = "DOC003", Nombres = "Juan",    ApellidoPaterno = "Mamani",   ApellidoMaterno = "Ccopa",  DNI = "42345678", FechaNacimiento = Utc(1985, 3, 12),  Sexo = TipoSexo.Masculino, Email = "jmamani@isterp.edu.pe",   GradoAcademico = "Magíster",  Especialidad = "Base de Datos",          TipoContrato = TipoContrato.PorHoras,      FechaIngreso = Utc(2020, 8, 1),  Sueldo = 1800 },
                new Docente { Codigo = "DOC004", Nombres = "Rosa",    ApellidoPaterno = "Condori",  ApellidoMaterno = "Apaza",  DNI = "43456789", FechaNacimiento = Utc(1978, 11, 5),  Sexo = TipoSexo.Femenino,  Email = "rcondori@isterp.edu.pe",  GradoAcademico = "Licenciada",Especialidad = "Contabilidad",           TipoContrato = TipoContrato.MedioTiempo,   FechaIngreso = Utc(2019, 3, 1),  Sueldo = 2500 },
                new Docente { Codigo = "DOC005", Nombres = "Pedro",   ApellidoPaterno = "Vargas",   ApellidoMaterno = "Tito",   DNI = "44567890", FechaNacimiento = Utc(1982, 7, 25),  Sexo = TipoSexo.Masculino, Email = "pvargas@isterp.edu.pe",   GradoAcademico = "Magíster",  Especialidad = "Economía",               TipoContrato = TipoContrato.TiempoCompleto, FechaIngreso = Utc(2017, 3, 1),  Sueldo = 3200 }
            );
            await context.SaveChangesAsync();
        }
        ...
        if (!await context.Estudiantes.AnyAsync())
        {
            ...
            {
                new() { Codigo = "EST2024001", Nombres = "Luis Alberto",  ApellidoPaterno = "García",    ApellidoMaterno = "López",   DNI = "76123401", FechaNacimiento = Utc(2003, 4, 15),  Sexo = TipoSexo.Masculino, Email = "lgarcia@est.isterp.edu.pe",   Telefono = "987001001", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024002", Nombres = "Ana Lucía",     ApellidoPaterno = "Mamani",    ApellidoMaterno = "Quispe",  DNI = "76123402", FechaNacimiento = Utc(2004, 7, 22),  Sexo = TipoSexo.Femenino,  Email = "amamani@est.isterp.edu.pe",   Telefono = "987001002", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024003", Nombres = "Marco Antonio", ApellidoPaterno = "Flores",    ApellidoMaterno = "Huanca",  DNI = "76123403", FechaNacimiento = Utc(2002, 11, 8),  Sexo = TipoSexo.Masculino, Email = "mflores@est.isterp.edu.pe",   Telefono = "987001003", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024004", Nombres = "Carla Beatriz", ApellidoPaterno = "Ramos",     ApellidoMaterno = "Ccopa",   DNI = "76123404", FechaNacimiento = Utc(2003, 2, 14),  Sexo = TipoSexo.Femenino,  Email = "cramos@est.isterp.edu.pe",    Telefono = "987001004", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024005", Nombres = "Jorge Luis",    ApellidoPaterno = "Condori",   ApellidoMaterno = "Apaza",   DNI = "76123405", FechaNacimiento = Utc(2001, 9, 30),  Sexo = TipoSexo.Masculino, Email = "jcondori@est.isterp.edu.pe",  Telefono = "987001005", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024006", Nombres = "Sofía",         ApellidoPaterno = "Vargas",    ApellidoMaterno = "Tito",    DNI = "76123406", FechaNacimiento = Utc(2004, 6, 18),  Sexo = TipoSexo.Femenino,  Email = "svargas@est.isterp.edu.pe",   Telefono = "987001006", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024007", Nombres = "David Raúl",    ApellidoPaterno = "Cusi",      ApellidoMaterno = "Marca",   DNI = "76123407", FechaNacimiento = Utc(2003, 1, 5),   Sexo = TipoSexo.Masculino, Email = "dcusi@est.isterp.edu.pe",     Telefono = "987001007", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024008", Nombres = "Patricia",      ApellidoPaterno = "Huallpa",   ApellidoMaterno = "Sinca",   DNI = "76123408", FechaNacimiento = Utc(2002, 10, 27), Sexo = TipoSexo.Femenino,  Email = "phuallpa@est.isterp.edu.pe",  Telefono = "987001008", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024009", Nombres = "Kevin Alexander",ApellidoPaterno = "Ttito",    ApellidoMaterno = "Quispe",  DNI = "76123409", FechaNacimiento = Utc(2003, 8, 12),  Sexo = TipoSexo.Masculino, Email = "kttito@est.isterp.edu.pe",    Telefono = "987001009", Estado = EstadoEstudiante.Retirado },
                new() { Codigo = "EST2024010", Nombres = "Milagros",      ApellidoPaterno = "Catunta",   ApellidoMaterno = "Puma",    DNI = "76123410", FechaNacimiento = Utc(2004, 3, 20),  Sexo = TipoSexo.Femenino,  Email = "mcatunta@est.isterp.edu.pe",  Telefono = "987001010", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024011", Nombres = "Rodrigo",       ApellidoPaterno = "Zamalloa",  ApellidoMaterno = "Cruz",    DNI = "76123411", FechaNacimiento = Utc(2002, 5, 3),   Sexo = TipoSexo.Masculino, Email = "rzamalloa@est.isterp.edu.pe", Telefono = "987001011", Estado = EstadoEstudiante.Activo   },
                new() { Codigo = "EST2024012", Nombres = "Valeria",       ApellidoPaterno = "Palomino",  ApellidoMaterno = "Góngora", DNI = "76123412", FechaNacimiento = Utc(2003, 12, 9),  Sexo = TipoSexo.Femenino,  Email = "vpalomino@est.isterp.edu.pe", Telefono = "987001012", Estado = EstadoEstudiante.Activo   }
            };
        ...
        if (!await context.Matriculas.AnyAsync())
        {
            ...
            for (int i = 0; i < estudiantes.Count; i++)
            {
                context.Matriculas.Add(new Matricula
                {
                    ...
                    FechaMatricula     = DateTime.UtcNow.AddDays(-(30 - i))
                });
            }
            await context.SaveChangesAsync();
        }
        ...
        if (!await context.Deudas.AnyAsync())
        {
            ...
            {
                new() { NumeroDeuda = "DEU-2025-00001", EstudianteId = estudiantes[0].Id, ConceptoPagoId = cMat,  PeriodoAcademicoId = periodo.Id, MontoOriginal = 250, FechaVencimiento = ahora.AddDays(-60), Estado = EstadoPago.Pagado   },
                new() { NumeroDeuda = "DEU-2025-00002", EstudianteId = estudiantes[0].Id, ConceptoPagoId = cPen1, PeriodoAcademicoId = periodo.Id, MontoOriginal = 450, FechaVencimiento = ahora.AddDays(-30), Estado = EstadoPago.Pagado   },
                new() { NumeroDeuda = "DEU-2025-00003", EstudianteId = estudiantes[0].Id, ConceptoPagoId = cPen2, PeriodoAcademicoId = periodo.Id, MontoOriginal = 450, FechaVencimiento = ahora.AddDays(15),  Estado = EstadoPago.Pendiente },
                new() { NumeroDeuda = "DEU-2025-00004", EstudianteId = estudiantes[1].Id, ConceptoPagoId = cMat,  PeriodoAcademicoId = periodo.Id, MontoOriginal = 250, FechaVencimiento = ahora.AddDays(-55), Estado = EstadoPago.Pagado   },
                new() { NumeroDeuda = "DEU-2025-00005", EstudianteId = estudiantes[1].Id, ConceptoPagoId = cPen1, PeriodoAcademicoId = periodo.Id, MontoOriginal = 450, MontoMora = 22.5m, FechaVencimiento = ahora.AddDays(-15), Estado = EstadoPago.Vencido  },
                new() { NumeroDeuda = "DEU-2025-00006", EstudianteId = estudiantes[2].Id, ConceptoPagoId = cMat,  PeriodoAcademicoId = periodo.Id, MontoOriginal = 250, FechaVencimiento = ahora.AddDays(-50), Estado = EstadoPago.Pagado   },
                new() { NumeroDeuda = "DEU-2025-00007", EstudianteId = estudiantes[2].Id, ConceptoPagoId = cPen1, PeriodoAcademicoId = periodo.Id, MontoOriginal = 450, FechaVencimiento = ahora.AddDays(-20), Estado = EstadoPago.Pendiente },
                new() { NumeroDeuda = "DEU-2025-00008", EstudianteId = estudiantes[3].Id, ConceptoPagoId = cPen2, PeriodoAcademicoId = periodo.Id, MontoOriginal = 450, MontoMora = 45m,   FechaVencimiento = ahora.AddDays(-40), Estado = EstadoPago.Vencido  },
                new() { NumeroDeuda = "DEU-2025-00009", EstudianteId = estudiantes[4].Id, ConceptoPagoId = cPen3, PeriodoAcademicoId = periodo.Id, MontoOriginal = 450, FechaVencimiento = ahora.AddDays(30),  Estado = EstadoPago.Pendiente },
                new() { NumeroDeuda = "DEU-2025-00010", EstudianteId = estudiantes[5].Id, ConceptoPagoId = cPen1, PeriodoAcademicoId = periodo.Id, MontoOriginal = 450, FechaVencimiento = ahora.AddDays(10),  Estado = EstadoPago.Pendiente },
                new() { NumeroDeuda = "DEU-2025-00011", EstudianteId = estudiantes[6].Id, ConceptoPagoId = cMat,  PeriodoAcademicoId = periodo.Id, MontoOriginal = 250, MontoMora = 25m,   FechaVencimiento = ahora.AddDays(-45), Estado = EstadoPago.Vencido  },
                new() { NumeroDeuda = "DEU-2025-00012", EstudianteId = estudiantes[7].Id, ConceptoPagoId = cPen2, PeriodoAcademicoId = periodo.Id, MontoOriginal = 450, FechaVencimiento = ahora.AddDays(5),   Estado = EstadoPago.Pendiente }
            };
